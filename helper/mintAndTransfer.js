...
const mintAndTransferObject = (data, txObject) => {
    ...
    txObject.data = myContract.methods
        .mintAndTransfer(
            [[royaltyReceiver, royaltyPercentage] ], toAddress, tokenId, metaHash
        )
        .encodeABI();
    // txObject.gasLimit = web3.utils.toHex(config.GAS.ERC721.MINTING.RESERVE);
};

const mintAndTransfer = async (data) => {
    var txObject = {};
    ...
    mintAndTransferObject(data, txObject);
...
module.exports = mintAndTransfer;
